...
var _cardPiece = __webpack_require__(28);

var _cardPiece2 = _interopRequireDefault(_cardPiece);

var _const = __webpack_require__(29);
...
var CardContainer = function (_Component) {
  ...
  _createClass(CardContainer, [{
    ...
    value: function componentDidMount() {
      var _cardsFlippedStatus = [];
      var amount = _const2.default.CARD_AMOUNT;
      while (amount--) {
    ...
    key: '_generateCards',
    value: function _generateCards() {
      var _this2 = this;

      var cardDomArray = [];
      var cardsFlippedStatus = this.state.cardsFlippedStatus;


      cardsFlippedStatus.forEach(function (element, index) {
        cardDomArray.push(_react2.default.createElement(_cardPiece2.default, { key: 'card' + index, index: index, pairIndex: element.pairIndex, flipped: element.flipped,
          handleCardClick: _this2._handleCardClick }));
      });
    ...
    value: function _generateRandomIndex() {
      while (true) {
    ...
    value: function _handleCardClick(index, pairIndex) {
      var _this3 = this;

      var _cardsFlippedStatus = this.state.cardsFlippedStatus;
      _cardsFlippedStatus[index].flipped = true;

      this.setState({
        cardsFlippedStatus: _cardsFlippedStatus
      }, function () {
        _this3._sameCardCheck(index, pairIndex);
      });
    }
  }, {
    key: '_sameCardCheck',
    value: function _sameCardCheck(index, pairIndex) {
      var _this4 = this;
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this._generateCards(_const2.default.CARD_AMOUNT)
        ),
        _react2.default.createElement(
          'div',
          { className: 'footer' },
...
var Card = function (_Component) {
  ...
  _createClass(Card, [{
    ...
    key: '_selectBackgroundByPairIndex',
    value: function _selectBackgroundByPairIndex(pairIndex) {
      switch (pairIndex) {
        case 0:
          return 'dc';
        case 1:
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'card-wrapper', onClick: this._handleCardClick },
        _react2.default.createElement('div', { className: flipped ? 'card flipped' : 'card' }),
        _react2.default.createElement('div', { className: flipped ? 'card-top flipped2 ' + this._selectBackgroundByPairIndex(this.props.pairIndex) : 'card-top ' + this._selectBackgroundByPairIndex(this.props.pairIndex) })
      );
    }
  }]);
